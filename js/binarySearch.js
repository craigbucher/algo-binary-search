function binarySearch(target, inputArray) {
    ...
    for (let i = 0; i < inputArray.length; i++) {
        ...
        if (midpoint > target) {
            ...
            return inputArray.indexOf(midpoint);
        }
    }
...
// console.log(binarySearch(7, largeArray));
